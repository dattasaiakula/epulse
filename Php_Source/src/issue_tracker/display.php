...
<body style="background: #E4E9F7;">
    ...
    <div class="row" style="text-align:center;">
        <label style="text-align:center;width: 215px;font-size:16px;padding-top:3px;margin-left:240px;">Select
            Customer</label>
    ...
    <form>
        <div class="main">
            ...
            <div class="row" style="margin-left: 10px;">
                ...
                <div class="col" style="width: 215px;margin-left: 550px;margin-bottom: 10px;">
            ...
            <table id="myTable" class="table table-striped " style="margin-left: 10px;">
                ...
                <tbody>
                    <?php
                        ...
                        $filterValue = document.getElementById('customer').value;
                        <!--$filterValue = "WHERE user_company = 'Box' ";-->
                        <!-- $filterValue = ""; -->
                        $result = mysqli_query($conn, $sql + $filterValue);
                        if($result){
                                while($row=mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                        <td scope="row"> <a href="issueId_View.php?edit_record_id='.$IssueId.'">'.$IssueId.'</a> </td>
                                        <td scope="row"> <a href="issueId_View.php?edit_record_id='.$IssueId.'">'.$IssueName.'</a> </td>
                                        <td scope="row"> '.$IssueType.' </td>
                                        <td scope="row"> '.$IssueDescription.' </td>
                                        <td scope="row"> '.$ProductTeam.' </td>
                                        <td scope="row"> '.$Area.' </td>
                                        <td scope="row"> '.$Priority.' </td>
                                        <td scope="row"> '.$Owner.' </td>
                                        <td scope="row" > 
                                            <option class="status" id="status" style="background-color: aqua;">'.$Status.'</option> 
                                        </td>
                                        <td scope="row"> '.$CreatedDate.' </td>
                                        <td scope="row"> '.$ReportedBy.' </td>
                                        <td scope="row"> '.$ModifiedDate.' </td>
                                       
                                        <td style="width: 120px;">
                                            <button>
                                                <a class=" col glyphicon glyphicon-pencil" value="Edit" href="update.php?updatedid/editind_recordId='.$IssueId.'" ></a>
                                            </button>
                                            <button>
                                            <a class=" col glyphicon glyphicon-list-alt" href="comments_page.php?commenting_recordId='.$IssueId.'" ></a>
                                            </button>
                                        </td>
