...
if (isset($_POST['username']) && isset($_POST['password']) ) {
	...
	$password = md5($pwd);
	//$role = "SELECT role from users.usersdata where username = '$username' AND password = '$password'";
	...
	if (empty($username)) {
        ...
        $sql = "SELECT * FROM users.usersdata WHERE username='$username' AND password='$password'";
