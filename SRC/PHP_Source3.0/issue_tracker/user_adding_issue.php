...
<?php
    ...
    if(isset($_POST['submit']) ){
        ...
        $sql = "INSERT INTO users.issue_tracker_tb(IssueName,IssueType,IssueDescription,ProductTeam,Area,Priority,Owner,Status,CreatedDate,user_company,ReportedBy)
        VALUES('$IssueName','$IssueType','$IssueDescription','$ProductTeam','$Area','$Priority','$Owner','$Status',Now(),'$company','$ReportedBy')";
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input readonly type="text" class="form-control" name="company" id="company"
                            style="text-align: center;" value="<?php echo $usercompany;?>"></input>
                    </div>
                    <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input readonly type="text" class="form-control" name="ReportedBy" id="ReportedBY"
                            style="text-align: center;" value="<?php echo $name;?>"></input>
                    </div>
                    <div class="col">
                        <label hidden for="issue"><b>Attachments</b></label><br />
                        <input hidden type="file" class="form-control" name="fileUpload" />
                    </div>
                </div>

                <div class="row">
                    <div class="col">
                        <label hidden for="issue"><b>Created Date</b></label><br />
                        <input hidden readonly type="text" class="form-control" name="CreatedDate" autocomplete="off" />
                    </div>
                </div>
