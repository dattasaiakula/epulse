...
<body>
    ...
    <div class="container mt-5">
        ...
        <a href="user_comments_page.php?commenting_recordId=<?=$Issueid?>" class="btn btn-primary my-3"
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <select hidden id="selectId" hidden class="form-control" name="ModifiedBy" autocomplete="off">
                    ...
                    <div class="col">
                        <label hidden for="issue"><b>Reported By</b></label><br />
                        <select hidden  class="form-control" name="ReportedBy" id="ReportedBy" autocomplete="off">
                            <option><?php echo $ReportedBy; ?></option>
                            <?php
                            $sql = "SELECT * FROM users.usersdata";
                                $res1 = mysqli_query($conn, $sql);
                            if($res1){
