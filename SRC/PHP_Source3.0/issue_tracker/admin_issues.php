...
<body style="background: #E4E9F7;">
    ...
    <div class="row" style="text-align:center;">
        ...
        <div class="col" style="width: 215px;margin-left: 300px;margin-bottom: 0px;">
            ...
            <a class="btn btn-primary" style="margin-left: 25px;border-bottom-width: 0px;" href="admin_adding_issue.php"
                            ...
                            <td style="width: 120px;">
                                <button>
                                    <a class=" col glyphicon glyphicon-pencil" value="Edit"
                                        href="issue_tracker/admin_issue_update.php?updatedid/editind_recordId=<?=$IssueId?>"></a>
                                </button>
                                <button>
...
<script>
    ...
    $(document).ready(function () {
        $("#customer").on('change', function () {
            ...
            //alert(value);
            $.ajax({
                url: "admin_customerRelatedData.php",
                type: "POST",
                data: 'request=' + value,
                beforeSend: function () {
