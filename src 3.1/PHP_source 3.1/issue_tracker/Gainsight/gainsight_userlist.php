...
<head>
    ...
    <div class="topnav" style="left: 60px;  width: 1459px;">
        ...
        <a href="gainsight_admin_creates_users.php" class="btn" type="button" >Add Users</a>
        ...
        <table id="myTable" class="table table-striped table-hover" style="width: 1500px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:start;">
                        <a href="gainsight-admin_updating_userdata.php?userId=<?=$id?>" class="btn btn-primary btn-sm"
