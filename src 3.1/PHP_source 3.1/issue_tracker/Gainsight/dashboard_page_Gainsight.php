...
<head>
    ...
    <div class="topnav">
        ...
        <?php
            ...
            //echo $rows['role'];
            if($rows['role'] == "Admin"){
                echo '<a href="issue_tracker/Gainsight/gainsight_userlist.php" class="btn" type="button">Users</a>';
            }
        ?>
    ...
    <div class="home-section">
        <main>
            <a class="btn btn-primary div2" href="training_portal/training_page.php"
                style="margin-left:50px;margin-top:100px;margin-bottom: 20px;padding-top: 70px; font-size:30px; background-color:cadetblue">Training</a>
            <a class="btn btn-primary div2" href="issue_tracker/Gainsight/gainsight_admin_issues.php"
                style="margin-top:100px;margin-left:50px; margin-bottom:20px; padding-top: 70px; font-size:30px; background-color: rgb(189, 107, 182);">Issue
                Tracker</a>
            <a class="btn btn-primary div2" href="pre-upgrade/admin/index.php"
                style="margin-left:50px;padding-top: 70px; font-size:30px; background-color: rgb(23, 204, 195);">Pre-Upgrade</a>
