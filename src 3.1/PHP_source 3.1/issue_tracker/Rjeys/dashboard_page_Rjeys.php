...
<head>
    ...
    <a class="btn active" href="../../homepage.php">Home</a>
     <?php
            ...
            //echo $rows['role'];
            if($rows['role'] == "Admin"){
                echo '<a href="issue_tracker/Rjeys/rjeys_userlist.php" class="btn" type="button">Users</a>';
            }
        ?>
...
<body>
    ...
    <div class="home-section">
        <main>
            ...
            <a class="btn btn-primary div2" href="issue_tracker/Rjeys/rjeys_admin_issues.php"
