...
<table id="myTable" class="table table-striped " style="margin-left: 10px;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td scope="row"> <a href="rjeys_issueId_View.php?edit_record_id=<?php echo $row['IssueId'] ?>">
            ...
            <td style="width: 120px;text-align:center;">
                <button
                    ...
                    <a class="btn btn-primary glyphicon glyphicon-pencil" value="Edit"
                        href="rjeys_admin_issue_update.php?updatedid/editind_recordId=<?php echo $row['IssueId'] ?>"></a>
                </button>
