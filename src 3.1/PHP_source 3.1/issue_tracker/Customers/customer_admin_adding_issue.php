...
<?php
    ...
    if(isset($_POST['submit']) && isset($_FILES['fileUpload'])){
        ...
        //$company = $_POST['company'];
            ...
            $path = "Customer_uploadedData/".$img_name;
            //echo $path;
        ...
        VALUES('$IssueName','$IssueType','$IssueDescription','$ProductTeam','$Area','$Priority','$Owner','$Status',Now(),'$usercompany','$ReportedBy','$path')";
        $result = mysqli_query($conn, $sql);
        if($result){
            //echo "Inserted Successfully";
            header('location: customer_issues.php');
        }else{
...
<head>
    ...
    <!-- Top Navigation Bar -->
    <div class="topnav" style="left: 60px; ">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <?php
                                $query1 = "SELECT company FROM id18088723_users.usersdata ";
                                $res = mysqli_query($conn, $query1);
                                if($res){
                                    while($rows=mysqli_fetch_array($res)){
                        ...
                        <input readonly type="text" class="form-control" name="company" id="company"
                            value="<?php echo $company?>" style="text-align: center;">
