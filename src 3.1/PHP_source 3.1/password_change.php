...
$id = $_GET['id'];
$sql = "SELECT * FROM id18088723_users.usersdata WHERE id=$id";
...
if(isset($_POST['save'])){
    ...
    $sql = "UPDATE id18088723_users.usersdata 
...
<body>
    <div class="container d-flex justify-content-center align-items-center " style="min-height: 100vh">
        <form class="border shadow p-3 rounded" action="" method="POST"
            ...
            <h4 class="text-center p-2" style="color:rgb(27, 160, 221);">Change Password</h4>
            <div class="input-group mb-3">
                <label for="password" class="form-label" style="color:rgb(27, 160, 221);">New Password</label>
            ...
            <div class="input-group mb-3">
                <label for="password" class="form-label" style="color:rgb(27, 160, 221);">Re-Enter Password</label>
