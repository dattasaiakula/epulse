...
<body>
    <div class="container d-flex justify-content-center align-items-center " style="min-height: 100vh">
        <form class="border shadow p-3 rounded" action="forget_password_request.php" method="post"
            ...
            <h4 class="text-center p-2" style="color:rgb(27, 160, 221);">Forget Your Password</h4>
            ...
            <h5 style="font-weight:normal; font-size:16px">
                <p style="color: rgb(180, 180, 171);">
                    ...
                    <br><br>
                    Username are in the form of an email address.<br>
            ...
            <div class="container my-2">
                <input type="button" class="btn btn-outline-primary" name="cancel" value="Cancel"
